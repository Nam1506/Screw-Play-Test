...
public class PopupBestValueBundle : PopupForce
{
    ...
    {
#if UNITY_EDITOR
        costText.text = costText.text = "$" + UIManager.Instance.UIShop.GetShopPackData(ShopItemKey.BestValueBundle).costValue;
#else
        //costText.text = Kernel.Resolve<BasePurchaser>().GetPriceText((int)ShopItemKey.BestValueBundle);
#endif
    }
